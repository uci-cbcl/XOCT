...
class UNet3D2DModel(BaseModel):
    ...
    def forward(self):
        self.fake_B, _, _, _, self.fake_B_3d2d_ilm_opl, self.fake_B_3d2d_opl_bm, self.fake_B_3d2d_other, _, _, _ = self.netG.forward(self.real_A, self.seg)
