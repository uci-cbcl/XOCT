...
class UNet3DMSFFModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        # define 3D Generator
        self.netG = UNet3DMSFF(in_channels=1, out_channels=1, base_ch=opt.base_ch_g, max_ch=opt.max_ch_g, norm=opt.norm, force_skip=True, add_scale=opt.add_scale)
