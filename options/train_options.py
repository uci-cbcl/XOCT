...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--val_epoch_freq', type=int, default=1, help='frequency of saving checkpoints at the end of epochs')
        ...
        parser.add_argument('--disable_lr_update', action='store_true', help='disable learning rate update')
        ...
        parser.add_argument('--seed', type=int, default=20, help='seed number for random initialization')
